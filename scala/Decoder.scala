...
class Decoder() extends Module {
  ...
  val opcodeMap: Array[(BitPat, List[UInt])] = Array(
    ...
    AND   -> List(Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.AND),
    OR   -> List( Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.OR),
    XOR  -> List( Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.XOR),
    SLT   -> List(Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.SLT),
    SLTU   -> List(Y,       N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.SLTU),
    SRA   -> List(Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.SRA),
    SRL   -> List(Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.SRL),
    SLL   -> List(Y,        N,       N,        N,       N,    branchType.DC, rs1,       rs2,       ITYPE,        ALUOps.SLL),

    JAL   -> List(  Y,        N,       N,        N,       Y,    branchType.jump,   PC,         imm,       JTYPE,        ALUOps.ADD),
    JALR   -> List( Y,        N,       N,        N,       Y,    branchType.jump,   rs1,        imm,       ITYPE,        ALUOps.ADD),

    BEQ   -> List(N,        N,       N,        Y,       N,    branchType.beq,  PC,       imm,       BTYPE,        ALUOps.ADD),
    BNE   -> List(N,        N,       N,        Y,       N,    branchType.neq,  PC,       imm,       BTYPE,        ALUOps.ADD),
    BLT   -> List(N,        N,       N,        Y,       N,    branchType.lt,   PC,       imm,       BTYPE,        ALUOps.ADD),
    BGE   -> List(N,        N,       N,        Y,       N,    branchType.gte,  PC,       imm,       BTYPE,        ALUOps.ADD),
    BLTU   -> List(N,       N,       N,        Y,       N,    branchType.ltu,  PC,       imm,       BTYPE,        ALUOps.ADD),
    BGEU   -> List(N,       N,       N,        Y,       N,    branchType.gteu, PC,       imm,       BTYPE,        ALUOps.ADD),

    LUI   -> List(Y,       N,       N,        Y,       N,    branchType.DC, rs1,       imm,       UTYPE,        ALUOps.ADD),
